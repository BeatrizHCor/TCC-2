...
router.get(
  "/funcionario/email/:email/:salaoId",
  FuncionarioController.findByEmailandSalao
);
router.get(
  "/funcionario/cpf/:cpf/:salaoId",
  FuncionarioController.findByCpfandSalao
);
...
router.get(
  "/auxiliar/salao/:salaoId",
  FuncionarioController.findAuxiliarBySalao
);
