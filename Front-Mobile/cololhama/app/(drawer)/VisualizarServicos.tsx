  ...
  if (error) {
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.retryButton} onPress={() => aplicarFiltros()}>
    ...
    return (
      <View style={styles.card}>
        ...
        <Text style={styles.cardPrice}>
          Preço Mín: R${typeof item.PrecoMin === 'number' && !isNaN(item.PrecoMin)
            ? item.PrecoMin.toFixed(2)
            : 'N/A'}
        </Text>
        <Text style={styles.cardPrice}>
          Preço Máx: R${typeof item.PrecoMax === 'number' && !isNaN(item.PrecoMax)
            ? item.PrecoMax.toFixed(2)
            : 'N/A'}
        </Text>
